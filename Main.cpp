...
int main()
{
    ...
    while (1) {
        ...
        if (next_checkpoint_angle > 90 || next_checkpoint_angle < -90) {
            ...
            thrust = 100 - 0.25 * abs(next_checkpoint_angle);
        }  

        if (next_checkpoint_dist < 1800) {
            thrust *= 0.3;
        }

        if (!boost_used && next_checkpoint_angle < 25 && next_checkpoint_angle > -25 && next_checkpoint_dist > 6000) {
